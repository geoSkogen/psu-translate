...
const style_string = "#translation-widget{position:fixed;right:1em;bottom:1em;background-color:white;border:2.33px solid gainsboro;padding:1em;}#lang{margin:0.75em;padding: 0.5em;border: 2.33px solid black;}#get-translation{background-color:black;color:white;font-weight:800;padding:0.75em;margin:0.5em;}"
