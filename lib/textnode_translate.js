...
function translate_text(str_arr, lang, dom_els, text_nodes) {
      ...
      if (dom_els[i].el) {
        ...
        switch( dom_els[i].el.tagName) {
          ...
          if (typeof text_nodes[i] != 'string') {
            text_nodes[i].textContent = new_str
  ...
  var resp
  //console.log(req)
  xhttp.open("POST", "../translation-service/", true)
  //xhttp.open("POST", "https://8b9a-2601-1c2-1902-3760-830d-9b1a-9064-6652.ngrok.io/psu-translate/translation-service/", true)
